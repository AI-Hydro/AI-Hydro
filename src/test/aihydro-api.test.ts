...
import type { AiHydroAPI } from "../exports/aihydro"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("AiHydroAPI Core Functionality", () => {
	let api: AiHydroAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createAiHydroAPI expects
		...
		// Create API instance
		api = createAiHydroAPI(mockController)
	})
