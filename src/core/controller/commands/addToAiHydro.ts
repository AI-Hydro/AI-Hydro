...
// 'Add to AI-Hydro' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToAiHydro(controller: Controller, request: CommandContext): Promise<Empty> {
	...
	console.log("addToAiHydro", request.selectedText, filePath, request.language)
