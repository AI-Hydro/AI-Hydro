...
/**
 * Combines API request start and finish messages in an array of AiHydroMessages.
 *
 ...
 * @returns A new array of AiHydroMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: AiHydroMessage[]): AiHydroMessage[] {
	const combinedApiRequests: AiHydroMessage[] = []
