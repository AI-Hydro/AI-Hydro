...
/**
 * Combines sequences of command and command_output messages in an array of AiHydroMessages.
 *
 * This function processes an array of AiHydroMessages objects, looking for sequences
 ...
 * @returns A new array of AiHydroMessage objects with command sequences combined.
 *
 * @example
 * const messages: AiHydroMessage[] = [
 ...
 */
export function combineCommandSequences(messages: AiHydroMessage[]): AiHydroMessage[] {
	const combinedCommands: AiHydroMessage[] = []
