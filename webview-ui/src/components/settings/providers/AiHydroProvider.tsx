...
import { AiHydroAccountInfoCard } from "../AiHydroAccountInfoCard"
import { DropdownContainer } from "../common/ModelSelector"
import OpenRouterModelPicker, { OPENROUTER_MODEL_PICKER_Z_INDEX } from "../OpenRouterModelPicker"
import { useApiConfigurationHandlers } from "../utils/useApiConfigurationHandlers"

/**
 * Props for the AiHydroProvider component
 */
interface AiHydroProviderProps {
...
/**
 * The AI-Hydro provider configuration component
 */
export const AiHydroProvider = ({ showModelOptions, isPopup, currentMode }: AiHydroProviderProps) => {
	...
	return (
		<div>
			{/* AI-Hydro Account Info Card */}
			<div style={{ marginBottom: 14, marginTop: 4 }}>
				<AiHydroAccountInfoCard />
			</div>
